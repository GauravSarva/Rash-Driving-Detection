...
#define EVENTO "Rash_Driving"
#define IFTTTKEY "pz735U9gzRtaXunTR40bwpKqxvAGwAoOAKx75ZWb55g"
...
const char* ssid = "OPPO A3s";   // ENTER THE NAME OF YOUR WIFI NETWORK.
const char* password = "*GAURAV*4*";  // ENTER THE PASSWORD OF YOUR WIFI NETWORK.
